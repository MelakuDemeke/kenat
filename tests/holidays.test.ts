...
describe('Holiday Calculation', () => {
    ...
    describe('Error Handling', () => {
        test('getHolidaysInMonth should throw for invalid input types', () => {
            expect(() => getHolidaysInMonth('2016' as any, 1)).toThrow(InvalidInputTypeError);
            expect(() => getHolidaysInMonth(2016, 'one' as any)).toThrow(InvalidInputTypeError);
        });
        ...
        test('getMovableHoliday should throw for invalid input type', () => {
            expect(() => getMovableHoliday('TINSAYE', null as any)).toThrow(InvalidInputTypeError);
